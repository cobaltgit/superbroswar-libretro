...
bool CResourceManager::LoadGameSounds()
{
    ...
    sfx_mip.init(convertPath("sfx/packs/mip.mp3", soundpack));
    sfx_deathsound.init(convertPath("sfx/packs/death.mp3", soundpack));
    sfx_jump.init(convertPath("sfx/packs/jump.mp3", soundpack));
    sfx_skid.init(convertPath("sfx/packs/skid.mp3", soundpack));
    sfx_capejump.init(convertPath("sfx/packs/capejump.mp3", soundpack));
    sfx_invinciblemusic.init(convertPath("sfx/packs/invincible.mp3", soundpack));
    sfx_extraguysound.init(convertPath("sfx/packs/1up.mp3", soundpack));
    sfx_sprout.init(convertPath("sfx/packs/sprout.mp3", soundpack));
    sfx_collectpowerup.init(convertPath("sfx/packs/collectpowerup.mp3", soundpack));
    sfx_collectfeather.init(convertPath("sfx/packs/feather.mp3", soundpack));
    sfx_tailspin.init(convertPath("sfx/packs/tail.mp3", soundpack));
    sfx_storepowerup.init(convertPath("sfx/packs/storeitem.mp3", soundpack));
    sfx_breakblock.init(convertPath("sfx/packs/breakblock.mp3", soundpack));
    sfx_bump.init(convertPath("sfx/packs/bump.mp3", soundpack));
    sfx_coin.init(convertPath("sfx/packs/coin.mp3", soundpack));
    sfx_fireball.init(convertPath("sfx/packs/fireball.mp3", soundpack));
    sfx_springjump.init(convertPath("sfx/packs/springjump.mp3", soundpack));
    sfx_timewarning.init(convertPath("sfx/packs/timewarning.mp3", soundpack));
    sfx_hit.init(convertPath("sfx/packs/hit.mp3", soundpack));
    sfx_chicken.init(convertPath("sfx/packs/chicken.mp3", soundpack));
    sfx_transform.init(convertPath("sfx/packs/transform.mp3", soundpack));
    sfx_yoshi.init(convertPath("sfx/packs/yoshi.mp3", soundpack));
    sfx_pause.init(convertPath("sfx/packs/pause.mp3", soundpack));
    sfx_bobombsound.init(convertPath("sfx/packs/bob-omb.mp3", soundpack));
    sfx_areatag.init(convertPath("sfx/packs/dcoin.mp3", soundpack));
    sfx_cannon.init(convertPath("sfx/packs/cannon.mp3", soundpack));
    sfx_burnup.init(convertPath("sfx/packs/burnup.mp3", soundpack));
    sfx_pipe.init(convertPath("sfx/packs/warp.mp3", soundpack));
    sfx_thunder.init(convertPath("sfx/packs/thunder.mp3", soundpack));
    sfx_slowdownmusic.init(convertPath("sfx/packs/clock.mp3", soundpack));
    sfx_flyingsound.init(convertPath("sfx/packs/slowdown.mp3", soundpack));
    sfx_storedpowerupsound.init(convertPath("sfx/packs/storedpowerup.mp3", soundpack));
    sfx_kicksound.init(convertPath("sfx/packs/kick.mp3", soundpack));
    sfx_racesound.init(convertPath("sfx/packs/race.mp3", soundpack));
    sfx_bulletbillsound.init(convertPath("sfx/packs/bulletbill.mp3", soundpack));
    sfx_boomerang.init(convertPath("sfx/packs/boomerang.mp3", soundpack));
    sfx_spit.init(convertPath("sfx/packs/spit.mp3", soundpack));
    sfx_starwarning.init(convertPath("sfx/packs/starwarning.mp3", soundpack));
    sfx_powerdown.init(convertPath("sfx/packs/powerdown.mp3", soundpack));
    sfx_switchpress.init(convertPath("sfx/packs/switchpress.mp3", soundpack));
    sfx_superspring.init(convertPath("sfx/packs/superspring.mp3", soundpack));
    sfx_stun.init(convertPath("sfx/packs/stun.mp3", soundpack));
    sfx_inventory.init(convertPath("sfx/packs/inventory.mp3", soundpack));
    sfx_worldmove.init(convertPath("sfx/packs/mapmove.mp3", soundpack));
    sfx_treasurechest.init(convertPath("sfx/packs/treasurechest.mp3", soundpack));
    sfx_flamecannon.init(convertPath("sfx/packs/flamecannon.mp3", soundpack));
    sfx_wand.init(convertPath("sfx/packs/wand.mp3", soundpack));
    sfx_enterstage.init(convertPath("sfx/packs/enter-stage.mp3", soundpack));
    sfx_gameover.init(convertPath("sfx/packs/gameover.mp3", soundpack));
    sfx_pickup.init(convertPath("sfx/packs/pickup.mp3", soundpack));
